...
public class msg_command_long extends MAVLinkMessage {
    ...
    public MAVLinkPacket pack() {
        System.out.println("MAVLINK_MSG_ID_COMMAND_LONG = " + command);
        System.out.println("MAVLINK_MSG_ID_COMMAND_LONG = " + param1);
        System.out.println("MAVLINK_MSG_ID_COMMAND_LONG = " + param2);
        System.out.println("MAVLINK_MSG_ID_COMMAND_LONG = " + param7);
