...
public class msg_param_value extends MAVLinkMessage {
    ...
    */
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_PARAM_VALUE - sysid:"+sysid+" compid:"+compid+" param_value:"+param_value+" param_count:"+param_count+" param_index:"+param_index+" param_id:"+param_id+" param_type:"+getParam_Id()+"";
    }
